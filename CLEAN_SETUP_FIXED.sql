-- ============================================================================
-- CLEAN ARCHITECTURE - COMPLETE SETUP (FIXED)
-- ============================================================================
-- This script applies all clean architecture migrations in order.
-- Drops existing functions before recreating them to avoid conflicts.
...
-- ============================================================================
-- PART 5: VECTOR SEARCH FUNCTIONS (DROP OLD VERSIONS FIRST)
-- ============================================================================

-- Drop existing functions with any signature
DROP FUNCTION IF EXISTS public.hybrid_search_documents(vector, text, uuid, uuid, integer);
DROP FUNCTION IF EXISTS public.get_chat_context(text, vector, uuid, uuid, integer);
