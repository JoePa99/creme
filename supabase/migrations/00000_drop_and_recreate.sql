-- Clean Architecture Migration - FRESH START
-- This drops all old tables and creates the new clean schema
-- ⚠️ WARNING: This will delete all existing data! Only run on a fresh instance.
...
-- Drop any old tables from previous architecture
...
-- ----------------------------------------------------------------------------
CREATE TABLE public.company_os (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  company_id UUID NOT NULL REFERENCES public.companies(id) ON DELETE CASCADE,
...
DO $$
BEGIN
  RAISE NOTICE '✅ Clean architecture core schema created successfully!';
  RAISE NOTICE 'Next steps:';
  RAISE NOTICE '1. Run 00002_rls_policies.sql';
  RAISE NOTICE '2. Run 00003_vector_functions.sql';
END $$;
